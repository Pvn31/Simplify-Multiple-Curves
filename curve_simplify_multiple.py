...
bl_info = {
    "name": "Simplify Multiple Curves+",
    "author": "testscreenings, Michael Soluyanov , edited by Pavan",
    "version": (1, 1, 1),
    "blender": (2, 80, 0),
    "location": "3D View, Dopesheet & Graph Editors",
    "description": "Simplify Multiple Curves: 3dview, Dopesheet, Graph. Distance Merge: 3d view curve edit",
    "warning": "",
    "category": "Add Curve",
}
